...
def animate_test_with_lidar():
    ...
    ax.set_title("Test:Statik Ortamda A*–RL Hibrit Mobil Robot", color='white')
...
def animate_train_traces_only(train_lw=0.30, train_alpha=0.35, trace_downsample=2):
    ...
    ax.set_title("Eğitim İzleri: Statik Ortamda A*–RL Hibrit Mobil Robot Rotaları", color='white')
    ax.set_xlabel("X (m)", color='white')
    ax.set_ylabel("Y (m)", color='white')
    ax.grid(False)
...
ani2 = animate_train_traces_only(train_lw=0.8, train_alpha=0.30, trace_downsample=2)
if ani2 is not None:
